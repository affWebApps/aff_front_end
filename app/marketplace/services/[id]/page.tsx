              ...
              >
                <div className="flex items-center gap-4 mb-6 border-b border-gray-200">
                  <button
                    ...
                    className={`text-lg font-bold pb-4 border-b-2 transition-colors ${activeTab === "reviews"
                  ...
                  <button
                    ...
                    className={`text-lg font-bold pb-4 border-b-2 transition-colors ${activeTab === "client"
                      ? "text-gray-900 border-[#FAB75B]"
                      : "text-gray-500 border-transparent"
                      }`}
                  >
