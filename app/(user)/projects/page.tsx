        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div className="flex gap-4 sm:gap-8 border-b border-gray-300 overflow-x-auto w-full sm:w-auto">
            <button
              ...
              className={`pb-3 px-1 whitespace-nowrap ${activeTab === "all"
            ...
            <button
              ...
              className={`pb-3 px-1 whitespace-nowrap ${activeTab === "drafts"
                ? "border-b-2 border-gray-800 text-gray-800 font-medium font-(family-name:--font-montserrat)"
                : "text-gray-500"
                }`}
            >
            ...
            <button
              ...
              className={`pb-3 px-1 whitespace-nowrap ${activeTab === "trash"
                ? "border-b-2 border-gray-800 text-gray-800 font-medium font-(family-name:--font-montserrat)"
                : "text-gray-500"
                }`}
            >
